	...
	function boot(el) {
		...
		var app = new Ractive({
			...
			components: {
				...
				filterFeature: __webpack_require__(11),
				fixedFilters: __webpack_require__(13),
				subView: __webpack_require__(15),
				backToTop:  __webpack_require__(17)
			},
